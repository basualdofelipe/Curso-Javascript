...
function nuevoJuego(nombre, precio){
...
formulario.addEventListener("submit", e => {
    e.preventDefault()
    nuevoJuego(tituloNuevoJuego.value, precioNuevoJuego.value)
    console.log(tituloNuevoJuego.value)
    console.log(precioNuevoJuego.value)
})